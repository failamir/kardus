                    ...
                    <tbody>
                      <tr>
                        <td class="text-primary">
                          {{ $t('cruds.notification.fields.id') }}
                        </td>
                        <td>
                          {{ entry.id }}
                        </td>
                      ...
                      <tr>
                        <td class="text-primary">
                          {{ $t('cruds.notification.fields.value') }}
                        </td>
                        <td>
                          <ckeditor
                            :editor="editor"
...
export default {
  ...
  computed: {
    ...mapGetters('NotificationsSingle', ['entry'])
  },
  watch: {
    '$route.params.id': {
      immediate: true,
  ...
  methods: {
    ...mapActions('NotificationsSingle', ['fetchShowData', 'resetState'])
  }
}
</script>
